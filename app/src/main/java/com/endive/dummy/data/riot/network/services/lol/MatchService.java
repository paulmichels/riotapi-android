...
public interface MatchService {
     ...
     */
    @GET("{region}/lol/match/v4/matches/by-tournament-code/{tournamentCode}/ids")
    Call<List<Long>> getIdsByTournamentCode(
            @Path("region") @RiotApi.Region String region,
     ...
     * @param tournamentCode The tournament code.
     */
    @GET("{region}/lol/match/v4/matches/{matchId}/by-tournament-code/{tournamentCode}")
    Call<Match> getByIdByTournamentId(
            @Path("region") @RiotApi.Region String region,
            @Path("matchId") long matchId,
            @Path("tournamentCode") String tournamentCode
    );
